      ...
      >
        ...
        {isSkipButton && progress < 100 && (
          <Button
            ...
            size="sm"
            onClick={handleSkip}
            className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 text-sm sm:text-base lg:text-lg transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer"
          >
            건너뛰기
          </Button>
        )}
